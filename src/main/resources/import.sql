insert into pessoa (nome, sexo) values('Leandra', 1);
insert into pessoa (nome, sexo) values('Fredson', 2);
insert into pessoa (nome, sexo) values('Marco', 2);
insert into pessoa (nome, sexo) values('Carlos Henrique', 2);
